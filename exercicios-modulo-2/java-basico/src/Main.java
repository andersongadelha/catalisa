...
//        System.out.println(resultado);
        ...
        System.out.println("Digite um numero para limitar a sequencia de Fibonacci:");
        numero = scanner.nextInt();
        if (numero > 0) {
            imprimirFibonacciPositivo(numero);
        } else if (numero < 0) {
            imprimirFibonacciNegativo(-numero);
        } else {
            System.out.println(0);
        }
    }

    public static void imprimirFibonacciPositivo(int numero) {
        int a = 0;
        int b = 1;
    ...
    public static void imprimirFibonacciNegativo(int numero) {
        int a = 0;
        int b = 1;
        for (int i = 0; i < numero; i++) {
            System.out.println(a + " ");
